--13-14 PK to 2nd Demographics
BEGIN;
DROP TABLE IF EXISTS clean_data.demographics_13_14_pk_2nd;
CREATE TABLE clean_data.demographics_13_14_pk_2nd AS
SELECT
    id
    , student_number
